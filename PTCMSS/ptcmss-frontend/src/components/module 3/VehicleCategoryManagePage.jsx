                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="relative">
                            ...
                            {showSuggestions && suggestions.length > 0 && (
                                <div
                                    className="absolute z-10 top-full left-0 right-0 mt-1 bg-white border border-slate-200 rounded-md shadow-lg max-h-40 overflow-y-auto">
                                    <div
                                        className="px-3 py-1.5 text-[10px] text-slate-500 bg-slate-50 border-b border-slate-100">
                            ...
                            {customers.map((c, idx) => (
                                ...
                                >
                                    <td className="px-4 py-3">
                                        <div className="flex items-center gap-2">
                                            <div
                                                className="h-8 w-8 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center text-[11px] font-semibold">
...
export default function VehicleCategoryManagePage() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F7FA] px-6 py-5">
            ...
            {/* TABLE */}
            <div className="mx-auto max-w-7xl rounded-xl border border-slate-200 bg-white shadow-sm overflow-hidden">
                <div className="px-6 py-4 border-b bg-slate-50 text-[13px] font-medium text-slate-700">
                ...
                {categories.length > 0 && (
                    <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50 px-4 py-3">
                        <div className="text-[12px] text-slate-500">
                            Hiển
                            thị {(catPage - 1) * catPageSize + 1} - {Math.min(catPage * catPageSize, categories.length)} / {categories.length} danh
                            mục
                        </div>
                        <div className="flex items-center gap-2">
                            <button
